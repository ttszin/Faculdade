...
Biblioteca = CDLL("./Biblioteca.DLL")
...
def main():
    ...
    if jogar == True:
        ...
        choris = Image(Point(150,470),"choris0.gif")          # PERSONAGEM
        choris.draw(jogo)
        ...
        circulo6 = Circle(Point(1400,485
        ),20)
        ...
        while end!=True:
            ...
            xA = circulo.getCenter().getX()                             
            xB = boxchoris.getCenter().getX()
            yA = circulo.getCenter().getY()
            yB = boxchoris.getCenter().getY()
            
            distancia = Biblioteca.Distancia(xA,Xb,yA,yB)
            ...
            xA2 = circulo2.getCenter().getX()
            xB2 = boxchoris.getCenter().getX()
            yA2 = circulo2.getCenter().getY()
            yB2 = boxchoris.getCenter().getY()
            ...
            xA3 = circulo3.getCenter().getX()
            xB3 = boxchoris.getCenter().getX()
            yA3 = circulo3.getCenter().getY()
            yB3 = boxchoris.getCenter().getY()
            ...
            xA4 = circulo4.getCenter().getX()                             
            xB4 = boxchoris.getCenter().getX()
            yA4 = circulo4.getCenter().getY()
            yB4 = boxchoris.getCenter().getY()
            ...
            xA5 = circulo2.getCenter().getX()
            xB5 = boxchoris.getCenter().getX()
            yA5 = circulo2.getCenter().getY()
            yB5 = boxchoris.getCenter().getY()
            ...
            xA6 = circulo3.getCenter().getX()
            xB6 = boxchoris.getCenter().getX()
            yA6 = circulo3.getCenter().getY()
            yB6 = boxchoris.getCenter().getY()
            ...
            if colisao == False:
                ...
                if pontos > 150:
                    ...
                    if pontos >= 2000:
                        jogo.close()
                        venceu = GraphWin("YOU WINNN",800,600)
